...
class BaseModel:
    ...
    def estimate_hurst_exponent(self, window_size=100, step_size=1):
        ...
        hurst_exponents = []
        print("111111check date: ",self.data["Date"])

        for i in range(0, len(self.data) - window_size + 1, step_size):
            # Extract the window
            window = self.data[f"Close_{self.trading_instrument}"].iloc[i : i + window_size]
        ...
        print("hurst_exponents: ", hurst_exponents)
    ...
    def train_test_split_time_series(self):
        ...
        feature_set = [
            ...
            # f"Short_Moving_Avg_2nd_Deriv_{self.trading_instrument}",
            # f"Long_Moving_Avg_2nd_Deriv_{self.trading_instrument}",
            # 'RSI',
            ...
            # f"%K_{self.trading_instrument}",
            # f"%D_{self.trading_instrument}",
            # 'Slow %K',
            # 'Slow %D',
            # 'KalmanFilterEst_1st_Deriv',
            # f"KalmanFilterEst_2nd_Deriv_{self.trading_instrument}",
